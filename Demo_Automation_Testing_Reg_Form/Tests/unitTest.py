...
class FormTest(unittest.TestCase):
    ...
    def test_form_validity(self):
        ...
        driver.find_element(By.XPATH,
                            '//body/section[@id="section"]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/textarea[1]').send_keys(
            "Malmö")
        driver.find_element(By.XPATH,
                            '//body/section[@id="section"]/div[1]/div[1]/div[2]/form[1]/div[3]/div[1]/input[1]').send_keys(
            "S@gmail.com")
        driver.find_element(By.XPATH,
                            "//body/section[@id='section']/div[1]/div[1]/div[2]/form[1]/div[4]/div[1]/input[1]").send_keys(
            "0123456789")
        # Gender
        driver.find_element(By.XPATH,
                            "//body/section[@id='section']/div[1]/div[1]/div[2]/form[1]/div[5]/div[1]/label[2]/input[1]").click()
        # Hobbies
